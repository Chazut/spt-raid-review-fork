...
Thank you for your interest in contributing to this project! We welcome contributions of all kinds, including bug fixes, new features, and documentation improvements. Before you start, please take a moment to read through this guide.
...
2. **Create a Pull Request**:
    ...
    - Choose the branch that contains your changes and the `4.0.X` branch to merge into.
...
3. **Merge and Release**:
    - After your changes are approved, they will be merged into the `4.0.X` branch.
    - Please note that all releases and pull requests to `main` will be managed and pushed by the repository owner.
